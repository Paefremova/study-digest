...
- **Сроки и задания.** Дедлайны со статусом ответа в ТУИС, просроченное, сдвинутые сроки,
  ...
  тесты с числом попыток и лимитом времени, выбор темы доклада — и выбрана ли она.
...
```markdown
# Учёба · вт 15.09 09:00

## Сроки

| Когда | Осталось | Работа | Курс | Состояние |
| ----- | -------- | ------ | ---- | --------- |
| **16.09 23:59** | **1 дн** | **ЛР 3** | **os-admin** | **не сдано** |
| 25.09 23:59 | 10 дн | Тема доклада к лекции 3 | nettech | не выбрана, 12 вариантов |
| 26.09 23:55 | 11 дн | ЛР 2 — Простые сети в GNS3 | nettech | не сдано |

## Баллы

| Курс | Итого | Новое |
| ---- | ----- | ----- |
| nettech | 12.23 / 13 | ЛР 1 7.45/8 |

## Новое в курсах

| Курс | Раздел | Что | Файлы |
| ---- | ------ | --- | ----- |
| os-admin | Лекции | Материалы: новые файлы | 003-dhcp.pdf |

## Предлагаю начать

**ЛР 3** · os-admin · до 16.09 23:59 · методички: os-admin/stash/
```
...
в `<код>/stash/`. Страницы курса, видео и образы пропускаются; файл, лежащий где угодно
внутри `stash/`, повторно не качается.
